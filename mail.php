...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	try {
		...
		if ($recaptcha == "3") {
			...
			$rcpSecret = "6LdU-FEfAAAAADPhnfCbr5XRgyoX7g_uyug40p_9";
		...
		$from = ("1" == "1" ? $_POST["email"] : "tekdude123@outlook.com");
		...
		// Send the mail
		if ( mail("MitchellPeck@mhseastcobb.com", $subject, $body, $headers) ) {
			json(true);
		}
	}
	catch (Exception $e) {
